...
const TramitesAdmin = () => {
  ...
  const [tiposTramite, setTiposTramite] = useState([]); // Estado para almacenar los tipos de trámite
  ...
  // Función para cargar los tipos de trámite
  const fetchTiposTramite = async () => {
    try {
      ...
      // No mostramos el error aquí para no interrumpir la carga principal
    }
  };
  ...
  useEffect(() => {
    fetchTramites();
    fetchTiposTramite(); // Cargar tipos de trámite al iniciar el componente
  }, []);
              ...
              <div className="bg-white rounded-xl shadow-2xl w-full max-w-md">
                <div className="p-6">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    {/* Dropdown para seleccionar el tipo de trámite */}
